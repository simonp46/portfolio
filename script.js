...
const TRANSLATIONS = {
    ...
    es: {
        ...
        typewriter: ["DESARROLLADOR FULL STACK", "DISE�?ADOR WEB", "DISE�?ADOR DE CHATBOTS", "DESARROLLADOR DE BASES DE DATOS"]
    },
    pt: {
    ...
    de: {
        "nav.home": "Start", "nav.about": "�?ber mich", "nav.services": "Leistungen", "nav.skills": "Fähigkeiten", "nav.demos": "Demos", "nav.contact": "Kontakt", "common.back": "Zurück",
    ...
    fr: {
        "nav.home": "Accueil", "nav.about": "�? propos", "nav.services": "Services", "nav.skills": "Compétences", "nav.demos": "Démos", "nav.contact": "Contact", "common.back": "Retour",
        ...
        "demos.heading": "Démo <span>en Vedette</span>", "demos.description1": "J'ai conçu et implémenté un MVP prêt pour la production appelé ClinicalProfileAgent, un copilote de documentation clinique assistée par IA pour thérapeutes respiratoires et professionnels de santé. Le système synchronise des sessions, traite les transcriptions, désidentifie les contenus sensibles, génère des brouillons structurés, crée des documents PDF/DOCX et centralise la revue dans un dashboard responsive.", "demos.description2": "La solution a été développée comme monorepo avec FastAPI, SQLAlchemy, Alembic, PostgreSQL, Celery, Redis, Next.js 15, TypeScript et Tailwind. Elle inclut JWT, récupération SMTP, OAuth Google/Microsoft, observabilité, tests, Docker Compose, CI/CD et déploiement cloud.", "demos.button": "Voir le website", typewriter: ["D�?VELOPPEUR FULL STACK", "WEB DESIGNER", "DESIGNER DE CHATBOTS", "D�?VELOPPEUR BASES DE DONN�?ES"]
    }
};
